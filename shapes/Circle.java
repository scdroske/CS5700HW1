...
public class Circle extends Ellipse{
    /**
     * currently what gets the min and max radius..
     * need to make it so that there is only one radius, but then it will go back and set min and max radius to be this radius
     *
     *
     *
     *
    ...
    /**
     * need to get rid of these somehow
     * @return
     */
    public double getMinRadius() { return radius; }
